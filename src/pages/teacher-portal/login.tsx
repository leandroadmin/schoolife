                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button type="button" onClick={() => toast.info("Por favor, solicite a redefinição de senha na secretaria da sua escola.", { description: "Seu acesso é gerenciado diretamente pela administração." })} className="text-[10px] font-bold text-amber-500 hover:text-amber-600 transition-colors uppercase tracking-widest">
                                            Esqueci a senha
                                        </button>
                                    </div>
                                    <div className="relative">
